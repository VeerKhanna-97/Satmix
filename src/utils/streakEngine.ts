...
export const STREAK_MILESTONES: StreakMilestone[] = [
  ...
  {
    days: 60,
    title: 'Diamond Anchor',
    badgeName: 'Emerald Crystal',
    rewardXp: 2500,
    perkDescription: '2 Months of consistent wealth accumulation',
    iconName: 'sparkles',
  },
  {
    days: 100,
  ...
  },
  {
    ...
    badgeName: 'Sapphire Shield',
    rewardXp: 10000,
    perkDescription: '6 Months of uninterrupted compounding autopilot',
    iconName: 'shield',
  },
  {
    days: 250,
    title: 'Quarter-K Titan',
    badgeName: 'Ruby Emblem',
    rewardXp: 15000,
    perkDescription: '250 Days of unshakable daily discipline',
    iconName: 'award',
  },
  {
    days: 365,
    title: 'Year One Sovereign',
    badgeName: 'Obsidian Crown',
    rewardXp: 25000,
    perkDescription: '365 Days — Top 0.1% Legendary Master Investor',
    iconName: 'crown',
  },
];
